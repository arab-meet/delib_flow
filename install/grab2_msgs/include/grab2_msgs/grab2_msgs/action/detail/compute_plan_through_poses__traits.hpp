...
inline void to_flow_style_yaml(
  const ComputePlanThroughPoses_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ComputePlanThroughPoses_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use grab2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  grab2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use grab2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event & msg)
{
  return grab2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event>()
{
  return "grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event";
}

template<>
inline const char * name<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event>()
{
  return "grab2_msgs/action/ComputePlanThroughPoses_SendGoal_Event";
}

template<>
struct has_fixed_size<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Request>::value && has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<grab2_msgs::action::ComputePlanThroughPoses_SendGoal_Event>
  : std::true_type {};
...
inline void to_flow_style_yaml(
  const ComputePlanThroughPoses_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ComputePlanThroughPoses_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use grab2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  grab2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use grab2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event & msg)
{
  return grab2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event>()
{
  return "grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event";
}

template<>
inline const char * name<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event>()
{
  return "grab2_msgs/action/ComputePlanThroughPoses_GetResult_Event";
}

template<>
struct has_fixed_size<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Request>::value && has_bounded_size<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<grab2_msgs::action::ComputePlanThroughPoses_GetResult_Event>
  : std::true_type {};
