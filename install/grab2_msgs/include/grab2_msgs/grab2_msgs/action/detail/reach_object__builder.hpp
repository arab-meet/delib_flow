...
class Init_ReachObject_SendGoal_Event_response
{
public:
  explicit Init_ReachObject_SendGoal_Event_response(::grab2_msgs::action::ReachObject_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::grab2_msgs::action::ReachObject_SendGoal_Event response(::grab2_msgs::action::ReachObject_SendGoal_Event::_response_type arg)
  {
...
private:
  ::grab2_msgs::action::ReachObject_SendGoal_Event msg_;
};

class Init_ReachObject_SendGoal_Event_request
{
public:
  explicit Init_ReachObject_SendGoal_Event_request(::grab2_msgs::action::ReachObject_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_ReachObject_SendGoal_Event_response request(::grab2_msgs::action::ReachObject_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ReachObject_SendGoal_Event_response(msg_);
  }
...
class Init_ReachObject_SendGoal_Event_info
{
public:
  Init_ReachObject_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ReachObject_SendGoal_Event_request info(::grab2_msgs::action::ReachObject_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ReachObject_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::grab2_msgs::action::ReachObject_SendGoal_Event>()
{
  return grab2_msgs::action::builder::Init_ReachObject_SendGoal_Event_info();
}
...
class Init_ReachObject_GetResult_Event_response
{
public:
  explicit Init_ReachObject_GetResult_Event_response(::grab2_msgs::action::ReachObject_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::grab2_msgs::action::ReachObject_GetResult_Event response(::grab2_msgs::action::ReachObject_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::grab2_msgs::action::ReachObject_GetResult_Event msg_;
};

class Init_ReachObject_GetResult_Event_request
{
public:
  explicit Init_ReachObject_GetResult_Event_request(::grab2_msgs::action::ReachObject_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_ReachObject_GetResult_Event_response request(::grab2_msgs::action::ReachObject_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ReachObject_GetResult_Event_response(msg_);
  }
...
class Init_ReachObject_GetResult_Event_info
{
public:
  Init_ReachObject_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ReachObject_GetResult_Event_request info(::grab2_msgs::action::ReachObject_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ReachObject_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::grab2_msgs::action::ReachObject_GetResult_Event>()
{
  return grab2_msgs::action::builder::Init_ReachObject_GetResult_Event_info();
}
