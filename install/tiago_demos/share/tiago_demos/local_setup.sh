...
: ${AMENT_CURRENT_PREFIX:="/Bt/install/tiago_demos"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_demos/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_demos/environment/path.sh"
