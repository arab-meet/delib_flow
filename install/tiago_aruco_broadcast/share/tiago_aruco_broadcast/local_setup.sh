...
: ${AMENT_CURRENT_PREFIX:="/Bt/install/tiago_aruco_broadcast"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_aruco_broadcast/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_aruco_broadcast/environment/path.sh"
