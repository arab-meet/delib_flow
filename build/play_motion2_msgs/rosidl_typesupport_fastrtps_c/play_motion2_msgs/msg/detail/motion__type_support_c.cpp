...
#include "play_motion2_msgs/msg/detail/motion__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // positions, times_from_start
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // positions, times_from_start
#include "rosidl_runtime_c/string.h"  // description, joints, key, name, usage
#include "rosidl_runtime_c/string_functions.h"  // description, joints, key, name, usage

// forward declare type support functions


using _Motion__ros_msg_type = play_motion2_msgs__msg__Motion;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: times_from_start
  {
    size_t size = ros_message->times_from_start.size;
    auto array_ptr = ros_message->times_from_start.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }
  ...
  play_motion2_msgs__msg__Motion * ros_message)
{
  ...
  // Field name: times_from_start
  {
    ...
    if (ros_message->times_from_start.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->times_from_start);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->times_from_start, size)) {
      fprintf(stderr, "failed to create array for field 'times_from_start'");
      return false;
    }
    auto array_ptr = ros_message->times_from_start.data;
    cdr.deserialize_array(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = play_motion2_msgs__msg__Motion;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const play_motion2_msgs__msg__Motion * ros_message = static_cast<const play_motion2_msgs__msg__Motion *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_play_motion2_msgs__msg__Motion(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  play_motion2_msgs__msg__Motion * ros_message = static_cast<play_motion2_msgs__msg__Motion *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_play_motion2_msgs__msg__Motion(cdr, ros_message);
}

static uint32_t _Motion__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_play_motion2_msgs__msg__Motion(
...
static size_t _Motion__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_play_motion2_msgs__msg__Motion(
