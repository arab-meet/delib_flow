...
enum
{
  grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ComputePlanThroughPoses in the package grab2_msgs.
typedef struct grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Request__Sequence request;
  grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Response__Sequence response;
} grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event;

// Struct for a sequence of grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event.
typedef struct grab2_msgs__action__ComputePlanThroughPoses_SendGoal_Event__Sequence
{
...
enum
{
  grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ComputePlanThroughPoses in the package grab2_msgs.
typedef struct grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  grab2_msgs__action__ComputePlanThroughPoses_GetResult_Request__Sequence request;
  grab2_msgs__action__ComputePlanThroughPoses_GetResult_Response__Sequence response;
} grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event;

// Struct for a sequence of grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event.
typedef struct grab2_msgs__action__ComputePlanThroughPoses_GetResult_Event__Sequence
{
