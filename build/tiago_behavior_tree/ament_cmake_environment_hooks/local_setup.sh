...
: ${AMENT_CURRENT_PREFIX:="/Bt/install/tiago_behavior_tree"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_behavior_tree/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tiago_behavior_tree/environment/path.sh"
