  ...
  void * untyped_ros_message)
{
  ...
  _GetTrees_Request__ros_msg_type * ros_message = static_cast<_GetTrees_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _GetTrees_Response__ros_msg_type * ros_message = static_cast<_GetTrees_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: tree_ids
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
