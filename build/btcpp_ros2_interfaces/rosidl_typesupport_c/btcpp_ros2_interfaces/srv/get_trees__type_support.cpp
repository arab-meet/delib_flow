...
static const _GetTrees_Request_type_support_symbol_names_t _GetTrees_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, srv, GetTrees_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, btcpp_ros2_interfaces, srv, GetTrees_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, btcpp_ros2_interfaces, srv, GetTrees_Request)() {
  return &::btcpp_ros2_interfaces::srv::rosidl_typesupport_c::GetTrees_Request_message_type_support_handle;
}
...
static const _GetTrees_Response_type_support_symbol_names_t _GetTrees_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, srv, GetTrees_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, btcpp_ros2_interfaces, srv, GetTrees_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, btcpp_ros2_interfaces, srv, GetTrees_Response)() {
  return &::btcpp_ros2_interfaces::srv::rosidl_typesupport_c::GetTrees_Response_message_type_support_handle;
}
...
static const _GetTrees_type_support_symbol_names_t _GetTrees_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, btcpp_ros2_interfaces, srv, GetTrees)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, btcpp_ros2_interfaces, srv, GetTrees)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, btcpp_ros2_interfaces, srv, GetTrees)() {
  return &::btcpp_ros2_interfaces::srv::rosidl_typesupport_c::GetTrees_service_type_support_handle;
}
